...
class DemoBox(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        #  start with binding to a normal event. The only argument
        ...
        # Next, bind to a standard property change event. This typically
        ...
        # Here I use anonymous functions (a.k.a lambdas) to perform binding.
        ...
        # as function re-use. Here, I use standard event binding to a function
        ...
        # Lastly, show how to use partial functions. They are sometimes
